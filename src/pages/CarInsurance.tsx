...
import { calculateInsurance } from '../logic/insuranceCalculations';
...
export default function CarInsurance() {
    const [values, setValues] = useState<InsuranceInput>({
        driverAge: 35,
        state: 'CA',
        vehicleType: 'sedan',
    ...
    const handleChange = (field: keyof InsuranceInput, value: any) => {
        setValues(prev => ({ ...prev, [field]: value }));
    };

    const result = calculateInsurance(values);
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-4)' }}>
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => handleChange('driverAge', parseInt(e.target.value) || 0)}
                                placeholder="35"
                            />
                        </div>
                        <div>
