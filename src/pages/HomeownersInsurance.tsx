...
import { calculateHomeownersInsurance } from '../logic/homeownersInsurance';
import type { HomeownersInput } from '../logic/homeownersInsurance';
...
export default function HomeownersInsurance() {
    const [values, setValues] = useState<HomeownersInput>({
        homeValue: 350000,
        state: 'CA',
    ...
    const handleChange = (field: keyof HomeownersInput, value: any) => {
        setValues(prev => ({ ...prev, [field]: value }));
    };

    const result = calculateHomeownersInsurance(values);
        ...
        <main style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 'var(--space-6)' }}>
            ...
            <header style={{ textAlign: 'center', marginBottom: 'var(--space-2)' }}>
                ...
                <p style={{ color: 'var(--color-text-secondary)', fontSize: '1.125rem' }}>
                    Get an instant estimate of your homeowners insurance premium
                </p>
            </header>
                    ...
                    <div>
                        ...
                        <div style={{ position: 'relative' }}>
                            ...
                            <input
                                ...
                                onChange={(e) => handleChange('homeValue', parseInt(e.target.value) || 0)}
                                placeholder="350000"
            ...
            <div style={{ maxWidth: '600px', margin: '0 auto', fontSize: '0.875rem', color: 'var(--color-text-secondary)', lineHeight: 1.6 }}>
                <p>
                    This tool provides an informational estimate of homeowners insurance costs based on common rating
                    factors such as home value, location, property type, and coverage level. The figures shown
                    are estimates only and are intended for general comparison purposes. Actual insurance
                    premiums vary based on home age, construction type, claims history, and individual
            ...
            <footer style={{ textAlign: 'center', padding: 'var(--space-8) var(--space-4)', color: 'var(--color-text-muted)', borderTop: '1px solid var(--color-border)', marginTop: 'var(--space-8)' }}>
                ...
                <p style={{ marginTop: 'var(--space-4)', fontSize: '0.75rem' }}>
                    &copy; 2026 Homeowners Insurance Cost Estimator. All rights reserved.
                </p>
            </footer>
